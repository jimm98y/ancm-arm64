...
if "%~1"=="uninstall" (
    move "%ProgramFiles%\IIS\Asp.Net Core Module\V2\aspnetcorev2_x64.dll" "%ProgramFiles%\IIS\Asp.Net Core Module\V2\aspnetcorev2.dll"
    del "%windir%\system32\inetsrv\aspnetcorev2_outofprocess_x64.dll"
)