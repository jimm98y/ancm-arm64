...
if "%~1"=="uninstall" (
	move "%ProgramFiles(x86)%\IIS\Asp.Net Core Module\V2\aspnetcorev2.dll.bak" "%ProgramFiles(x86)%\IIS\Asp.Net Core Module\V2\aspnetcorev2.dll"
    move "%ProgramFiles(x86)%\IIS\Asp.Net Core Module\V2\%~2\aspnetcorev2_outofprocess.dll.bak" "%ProgramFiles(x86)%\IIS\Asp.Net Core Module\V2\%~2\aspnetcorev2_outofprocess.dll"
)
